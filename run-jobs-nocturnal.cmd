...
set "CMD_LOG_PATH=D:\SPA\Python\cmd_execution_nocturnal.log"
...
REM Inicio del log
echo Inizio esecuzione nocturnal jobs: %date% %time% > "%CMD_LOG_PATH%"

REM Ejecución del script Python con parámetro 3 (nocturnal)
"%PYTHON_PATH%" "%SCRIPT_PATH%" 3 >> "%CMD_LOG_PATH%" 2>&1
...
echo Fine esecuzione nocturnal jobs: %date% %time% >> "%CMD_LOG_PATH%"
